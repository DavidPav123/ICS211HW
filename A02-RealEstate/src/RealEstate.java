/**
 * Allows for the creation of house objects through user input
 * Puts the House objects into a list once created
 * House objects can be removed from the list once added
 * The complete list of house objects can also be printed
